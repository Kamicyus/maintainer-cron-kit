...
- Add `mck release-notes` for release-note draft generation from closed pull requests.
- Add `mck doctor` for workflow environment checks.
- Add read-only GitHub Actions examples.
- Add security, contribution, and application notes.
